...
<head>
    ...
    <link rel="stylesheet" href="{{ vite_asset('resources/scss/front.scss') }}">
    <script type="module" src="{{ vite_asset('resources/js/front.js') }}"></script>
