<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="pt-3 shrink-0 flex items-center">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('price-tables.index')" :active="request()->routeIs('price-tables')">
                        {{ __('Tabela Preços') }}
                    </x-nav-link>
                    <x-nav-link :href="route('colaboradores.index')" :active="request()->routeIs('products.index')">
                        {{ __('Colaboradores') }}
                    </x-nav-link>
